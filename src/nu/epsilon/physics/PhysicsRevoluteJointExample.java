 ...
 */
public class PhysicsRevoluteJointExample extends BasePhysicsJointsExample {
	// ===========================================================
	// Constants
	// ===========================================================
	...
	private void initJoints(final Scene pScene) {
		...
		final float anchorFaceX = centerX
				- this.mBoxFaceTextureRegion.getWidth() * 0.5f;
		final float anchorFaceY = centerY
				- this.mBoxFaceTextureRegion.getHeight() * 0.5f;

		final AnimatedSprite anchorFace = new AnimatedSprite(anchorFaceX,
				anchorFaceY, this.mBoxFaceTextureRegion);
		final Body anchorBody = PhysicsFactory.createBoxBody(this.mPhysicsWorld, anchorFace, BodyType.StaticBody, this.fixtureDef);

		final AnimatedSprite movingFace = new AnimatedSprite(anchorFaceX,
				anchorFaceY + 100, this.mBoxFaceTextureRegion);
		final Body movingBody = PhysicsFactory.createBoxBody(this.mPhysicsWorld, movingFace, BodyType.DynamicBody, this.fixtureDef);
		...
		this.mPhysicsWorld.registerPhysicsConnector(new PhysicsConnector(
				anchorFace, anchorBody, true, true, false, false));
		this.mPhysicsWorld.registerPhysicsConnector(new PhysicsConnector(
				movingFace, movingBody, true, true, false, false));
		...
		this.mRevoluteJoint = (RevoluteJoint) this.mPhysicsWorld
				.createJoint(revoluteJointDef);
		Toast.makeText(this,
				"Motor speed: " + this.mRevoluteJoint.getMotorSpeed(),
